...
waterMelons = int(input('Количество арбузов: '))
waterMelonsMass = [int(input(f'Масса арбуза {i+1}: ')) for i in range(waterMelons)]

print (f'Минимальная масса: {min(waterMelonsMass)}')
print (f'Максимальная масса: {max(waterMelonsMass)}')