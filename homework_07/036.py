...
Вывод:print_operation_table(lambda x, y: x * y)
1         2         3        4        5       6
2         4         6        8       10      12
3         6         9       12       15      18
4         8        12       16       20      24
...
Нумерация не с нуля потому что в лямбда записана операция умножения.
'''

def print_operation_table(operation, num_rows=6, num_columns=6):
	[
	print('\t\t'.join(
		[str(operation(r, c)) 	for c in range(1, num_columns + 1)]
